...
A modest benchmark was devised to gain some insight in image
I/O patterns for a few packages easily accessible to us: CASA,
MIRIAD and NEMO. MIRIAD is the standard analysis package for
...
can be tuned to optimize the access speed for the specific
cube dimensions.  Current, CASA does not actively
MIRIAD has a traditional row based access, but rarely
