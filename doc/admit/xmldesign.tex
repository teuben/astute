...
Without the full and cumbersome to read XML syntax, here is
an overview of the XML tree that {\tt admit.zip} will contain.
The odd looking {\tt [N]} looking notation means this item
will occur {\tt N} times at this level, for example for
...
% Is there really a clear distinction 
...
value of the datasets\footnote{or even a user trying ADMIT on non-ALMA data}.
