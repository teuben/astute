...
spectral resolution. Depending on the amount of lines in the spectra,
...
possible on a scale never been seed before. Principle Component
...
in which regions certain 

\subsection{Principal Component Analysis}

An extension of the overlap integral would be to not use a simple on/off bit,
but create a vector containing the full strength for each line, and 
